...
/*
    2. conditional logic:
        ...
        Based on their age, use conditional statements to output different
        messages. For example if the age is below 18 display "You are a minor"
        if between 18 and 65 display "you are an adult" and if above 65 display
